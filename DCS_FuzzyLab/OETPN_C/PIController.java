...
public class PIController {
	public static void main (String[]args) throws FileNotFoundException {
		...
		//pn.SetInputFile("E:\\uni\\an4\\sem1\\DCS_lab\\dcs-lab-giuliaa03\\DCS_lab\\Lab4\\PIController.txt");
		...
		input3.add(new PlaceNameWithWeight("P5", 0.97F));
		input3.add(new PlaceNameWithWeight("P7", 0.01F));
