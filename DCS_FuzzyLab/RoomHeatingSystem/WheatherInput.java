...
public class WheatherInput {
	public static void main(String[] args) throws InterruptedException, IOException {
		File plant = new File("E:\\uni\\an4\\sem1\\DCS_lab\\Lab4\\PetriInputData\\OutsideTemp.txt");
		Files.deleteIfExists(plant.toPath());

		File RTC = new File("E:\\uni\\an4\\sem1\\DCS_lab\\Lab4\\PetriInputData\\RTC.txt");
		Files.deleteIfExists(RTC.toPath());

		File HTC = new File("E:\\uni\\an4\\sem1\\DCS_lab\\Lab4\\PetriInputData\\HTC.txt");
